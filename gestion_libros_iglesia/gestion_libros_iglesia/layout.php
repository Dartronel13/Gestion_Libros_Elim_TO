...
<head>
    ...
    <title>Biblioteca Elim TO</title>
                    ...
                    <?php if(file_exists('images/logo.png')): ?>
                        <div class="logo-image-wrapper">
                            <img src="images/logo.png" 
                                alt="Logo Biblioteca Elim TO" 
                                class="navbar-logo auto-fit">
                        </div>
                    <?php else: ?>
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="footer-logo-container">
                        ...
                        <div class="footer-text">
                            <h6 class="mb-0 fw-bold text-white">Biblioteca Elim TO</h6>
                            <small class="text-white-75">Sistema de Gestión Bibliotecaria</small>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 text-md-end mt-3 mt-md-0">
                    <p class="mb-0 small text-white">
                        ...
                        <br>
                        <span class="text-white-75">v1.0.0</span>
                    </p>
                </div>
            </div>
            <hr class="my-3 text-white-50">
            <div class="text-center small text-white-75">
